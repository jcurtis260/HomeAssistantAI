...
class AiAgentHaAgent:
    ...
    SYSTEM_PROMPT = {
        ...
        "content": (
            ...
            "  IMPORTANT JSON FORMAT: Use {\"request_type\": \"get_entities_by_device_class\", \"parameters\": {\"device_class\": \"motion\"}}\n"
            "  NEVER use array syntax like [\"device_class\": \"motion\"] - parameters must be an object {}\n"
            ...
            "  IMPORTANT: This is a FUNCTION/COMMAND, NOT a service call. Use it as a data request type.\n"
            "  Format: {\"request_type\": \"update_dashboard\", \"parameters\": {\"dashboard_url\": \"...\", \"dashboard_config\": {...}}}\n"
            "  DO NOT use call_service() for this - use update_dashboard() directly as a request type.\n"
            "  This function CAN update both YAML and JSON/Storage mode dashboards.\n"
            "  For YAML dashboards, it reads the existing file, merges your changes, and writes it back.\n"
            "  For Storage mode dashboards, it uses the Lovelace API.\n"
            "  When adding entities to existing views, the function will merge them with existing cards.\n"
            "  You CAN update YAML dashboards - just use update_dashboard() with the dashboard URL and new config.\n"
            "  WORKFLOW FOR UPDATING DASHBOARDS:\n"
            "  1. First, use get_dashboards() to find the dashboard URL (e.g., 'living-room-lights')\n"
            "  2. Then, use get_dashboard_config(dashboard_url) to get the current dashboard structure\n"
            "  3. Use get_entities_by_area() or other get_* commands to find entities to add\n"
            "  4. Create a dashboard_config with the new cards/entities you want to add\n"
            "  5. FINALLY, use request_type: 'update_dashboard' with parameters to actually update it\n"
            "  DO NOT stop after making data requests - you MUST call update_dashboard() to complete the task!\n\n"
