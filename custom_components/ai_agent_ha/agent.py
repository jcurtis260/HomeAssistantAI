...
class AiAgentHaAgent:
    ...
    SYSTEM_PROMPT = {
        ...
        "content": (
            ...
            "  IMPORTANT: This function CAN update both YAML and JSON/Storage mode dashboards.\n"
            ...
            "  5. FINALLY, call update_dashboard(dashboard_url, dashboard_config) to actually update it\n"
